      ...
      {loading ? (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 animate-fade-in min-w-0">
          {Array.from({ length: 4 }).map((_, idx) => (
            <div
              key={idx}
              className="bg-card dark:bg-[#111111] p-5 rounded-2xl border border-border dark:border-[#1a1a1a] shadow-sm min-w-0"
            >
        ...
        <div className="bg-card dark:bg-[#111111] p-6 rounded-2xl border border-border dark:border-[#1a1a1a] shadow-sm animate-fade-in min-w-0 overflow-hidden">
          ...
          <div className="flex gap-4 overflow-hidden">
            {Array.from({ length: 2 }).map((_, idx) => (
              <div key={idx} className="flex-shrink-0 w-80 p-4 rounded-lg border border-border">
                <div className="flex items-center justify-between mb-3">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <div className="shimmer w-20 h-3 rounded" />
                    <div className="shimmer w-4 h-3 rounded" />
                  </div>
                  <div className="flex justify-between">
          ...
          <>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-start sm:items-center gap-2 min-w-0">
                <div className="shimmer w-24 h-8 rounded-full" />
                <div className="shimmer w-32 h-8 rounded-full" />
                <div className="shimmer w-28 h-8 rounded-full" />
                <div className="shimmer w-32 h-8 rounded-full" />
              </div>
            </div>
            ...
            <div className="space-y-4">
              {Array.from({ length: 5 }).map((_, idx) => (
                <div key={idx} className="px-6 py-4 border-b border-border last:border-b-0">
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <div className="shimmer w-12 h-6 rounded" />
                      <div>
                        <div className="shimmer w-32 h-4 rounded mb-2" />
